...
Pega somente os resumos dos artigos de cada edição do WIT contendo palavras chave
"""

from bs4 import BeautifulSoup
import requests

url = 'https://sol.sbc.org.br/index.php/wit/issue/archive'
...
file = open('Coleta_WIT_2022-2016.csv','w')
